...
/**
 * Fallback web de estadísticas del Mundial: cuando API-Football no está
 * disponible, recolecta resultados de fuentes públicas (Wikipedia) y produce
 * los KPIs con el contrato del prompt (summary, leaders, fuentes,
 * no_encontrados, status). Reutiliza aggregateFixtures para los KPIs de equipo
 * (no se recalcula nada a mano) y solo añade el goleador por conteo directo.
 *
